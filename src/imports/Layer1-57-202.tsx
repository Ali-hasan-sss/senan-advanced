  ...
  return (
    <div className="relative size-full" data-name="Layer_1">
      ...
      >
        ...
        >
          <path d={svgPaths.p2a4fcf00} fill="white" id="Vector" opacity="0.4" />
        </svg>
      </div>
      <div
      ...
      >
        ...
        >
          <path d={svgPaths.pcbdc780} fill="white" id="Vector" opacity="0.4" />
        </svg>
      </div>
      <div
      ...
      >
        ...
        >
          <path d={svgPaths.p3af35600} fill="white" id="Vector" opacity="0.4" />
        </svg>
      </div>
    </div>
  );
